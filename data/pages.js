...
const PAGES = {
  ...
  55: {
    ...
    url   : 'pages/55/',
    thumb : null,
    desc  : '실제 플레이 가능한 웹 음악 믹서 — 42종 사운드, 16스텝 시퀀서, 무제한 트랙 추가, 프리셋 5종, Web Audio API 완전 합성',
  },
  ...
  59: {
    ...
    url   : 'pages/59/',
    thumb : null,
    desc  : 'futamoji 기물 · 튜토리얼+퀴즈(詰み)+AI 5단계(최하~최상) · 알파-베타 탐색 · 타기·승격·打ち歩詰め 완전 구현',
  },

  // 61 ~ 100: 아직 미등록 — 번호 추가 시 위 형식으로 작성
};
