...
const PAGES = {
  ...
  68: {
    label : '그림 구도 & 요소 완전 가이드',
    url   : 'pages/68/',
    thumb : null,
    desc  : '구도 법칙 8가지·카메라 앵글·인체 비례·제스처·근육·거유 체형·폐허 배경·기계/SF·자연(나무/물/바위/구름)·빛과 색·참고 유튜브 채널 총정리',
  },
  ...
  69: {
    ...
    url   : 'pages/69/',
    thumb : null,
    desc  : '일본 리치 마작 — 패 종류·게임 흐름·치·폰·깡·리치·론·쯔모 · 역(役) 35종 · 점수 계산 · 용어 사전',
  },
  ...
  70: {
    ...
    url   : 'pages/70/',
    thumb : null,
    desc  : '필기 이론(2급 2과목 · 1급 3과목) + 과목당 100문제 총 500문제 퀴즈 + 실기 문제 구성·전략 및 예시문제 40제',
  },
  ...
  75: {
    label : 'Blockbench 기능 & 단축키',
    url   : 'pages/75/',
    thumb : null,
    desc  : '포맷 10종 · 모드 4개 · 도구 20개 · 패널 18개 · 메뉴 전체 · 기본 단축키 94개 · 키맵 프리셋 비교(Blender/C4D/Maya) · 환경 설정 · 실전 팁',
  },
  ...
  76: {
    ...
    url   : 'pages/76/',
    thumb : null,
    desc  : '시민팀·마피아팀·교주팀 전 직업 · 접선 시스템 · 듀얼 스킬 · 용어 119개 · 게임 모드·랭크·제재 · 초보 공략 · 계정 탈퇴/리세 방법 총정리',
  },
  ...
  77: {
    ...
    url   : 'pages/77/',
    thumb : null,
    desc  : '마우스 포인터 쪽으로 걸으며 어두운 공간 7곳을 지나감 · 대사·글자 없음 · 죽지 않음 · 시야 차폐 조명, 절차적 지형, 합성 음향',
  },
  ...
  78: {
    ...
    url   : 'pages/78/',
    thumb : null,
    desc  : '초기 비트 모음 43종 + 추가 비트 모음 100종 · 고정 프리셋 11종 + 장르 랜덤 · 크루 드래그 앤 드롭 · 팝업 플레이어로 다른 사이트에서도 계속 재생 · 저장/관리·JSON·WAV 내보내기',
  },
  ...
  79: {
    ...
    url   : 'pages/79/',
    thumb : null,
    desc  : 'Studio 사용법·테스트 4종 · 맵 빌딩(파트·지형·조명·제약) · 계층 구조 · 스크립트 3종 · Luau 문법 전반 · API/자료형(CFrame·Raycast) · 서비스 20종 · RemoteEvent 보안 · 캐릭터·도구 · UI · DataStore · 실전 코드 15종 · 디버깅·최적화 · 배포·수익화 · 용어 사전',
  },
  ...
  80: {
    ...
    url   : 'pages/80/',
    thumb : null,
    desc  : '이름만 정하면 바로 쓰는 zip 다운로드 · 표준 폴더 전부 생성 + 폴더마다 설명서 · 키트 7종(폴더뼈대/RPG/보스/지팡이 등) · 1.19~1.21.5+ 버전별 폴더·문법 자동 처리 · 레이캐스트·매크로·스코어보드 검증 코드 포함',
  },

  81: {
    label : '수원대 AI 데이터과학부 정리',
    url   : 'pages/81/',
    thumb : null,
    desc  : '26학번 학기별 커리큘럼 (1학년~4학년) · 졸업 요건 · GPA 학점 제도 · 권장 자격증 9종 · 취득 역량 · 인턴십·캡스톤·학부연구생 안내',
  },
  ...
  82: {
    ...
    url   : 'pages/82/',
    thumb : null,
    desc  : '녹음 버튼을 누르고 말하면 실시간으로 받아쓰고, 멈추면 한 줄 요약·핵심 문장·키워드로 정리 · 정리 내용 복사 · .txt 저장 · 5개 언어',
  },
  ...
  83: {
    ...
    url   : 'pages/83/',
    thumb : null,
    desc  : '지오지브라처럼 보이는 대로 수식 입력(MathLive) · 코드는 복사할 때만 표시 · 한글·영어 삽입 · 빠른 입력((a+b)/2)·코드 직접 입력 모드 · 기호 팔레트 194개(읽는 법·영어 이름 검색) · 코드 뜻 풀이 · 기호 사전(검색) · 예제 40개 · 연습 문제 24개 채점 · 문법 가이드',
  },
  ...
  84: {
    ...
    url   : 'pages/84/',
    thumb : null,
    desc  : '고양이 마리오식 트롤 플랫포머 — 죽지 않고 놀란다 · 함정 20종(유령발판·투명벽·화면반전·중력반전·대왕얼굴 등) · 매판 지형·함정 배치·정체가 전부 랜덤 · 지하 동굴 탐험 + 생선 수집 · 시드 공유 · 놀람 기록/등급 · 소리·흔들림·번쩍임 끄기 옵션',
  },
  ...
  86: {
    ...
    url   : 'pages/86/',
    thumb : null,
    desc  : '품사 8종(명사·대명사·동사·형용사·부사·전치사·접속사·관사) · 12시제 · 5형식 · 조동사 완전 정리 · 가정법 0~3형+혼합 · 수동태·관계사·to부정사vs동명사·분사구문·비교급·도치 심화',
  },
  ...
  87: {
    ...
    url   : 'pages/87/',
    thumb : null,
    desc  : '소설 설정용 계급 체계 16종 149단계 — 서양귀족·조선품계·중세신분·군계급·성직 / 궁정·기사단·마법사탑·신전·모험가길드·마왕군·암살조직·아카데미·용족·엘프·드워프 · 피라미드+표 보기 · 직접 만드는 편집기(색·순서·저장) · 마크다운/텍스트/JSON 내보내기 · 작법 팁 20개',
  },
  ...
  85: {
    ...
    url   : 'pages/85/',
    thumb : null,
    desc  : '방치용 생태 시뮬레이션 — 친해지고 미워하고 태어나고 죽는다 · 모여서 구역이 되고 갈라지고 싸우다 화해한다 · 함정을 묻고 알아채고 푼다 · 늪·열지대·들불이 일방적으로 때린다 · 배우고 가르치고 논다 · 똑똑함·무능함·순수함·배척 · 개체/변종 놓기, 지형 그리기, 재해, 화해·싸움 붙이기 등 개입 도구 11종 · 시점 자동 이동',
  },

  // 88 ~ 100: 아직 미등록 — 번호 추가 시 위 형식으로 작성
};
